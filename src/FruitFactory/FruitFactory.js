...
export const fruitFactory = [
  ...
  new Fruit('Pomidor', 140, 4, 0.50, 1, '40%', '-0.1%'),
  new Fruit('Szpinak', 560, 4, 2.10, 1, '49.78%', '7.6%'),
  new Fruit('Cebula', 480, 4, 1.76, 1, '80.3%', '-0.2%'),
  new Fruit('Kalafior', 1000, 4, 3,78, 1, '11.7%', '17.6%'),
  new Fruit('Ziemniak', 960, 4, 3,60, 1, '19.9%', '15%'),
  new Fruit('Czosnek', 1320, 4, 5.10, 1, '40%', '7.65%'),
  new Fruit('Papryka', 2400, 5, 7,32, 1, '40%', '2.5%'),
  new Fruit('Brokuł', 1200, 4, 4.48, 1, '20%', '7.6%'),
  new Fruit('Oberżyna', 2880, 5, 8.88, 1, '60.3%', '0%'),
  new Fruit('Cukinia', 2880, 4, 11, 1, '50%', '2.5%'),
  new Fruit('Malina', 2880, 5, 7.60, 1, '90.4%', '0%'),
  ...
  new Fruit('Porzeczka', 2160, 6, 5.75,75, 1, '-.2%', '2.5%'),
